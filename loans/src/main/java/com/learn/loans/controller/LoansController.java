...
@Tag(
        name = "CRUD REST APIs for Loans in YourBank",
        description = "CRUD REST APIs in YourBank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @PostMapping("/create")
    public ResponseEntity<ResponseDto> createLoans(@RequestParam @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number must be 10 digits") String mobileNumber) {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoansDto> fetchLoansDetails(@RequestParam @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number must be 10 digits") String mobileNumber) {
    ...
    @Operation(
            ...
            description = "Get Build Information that is deployed onto loans microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Java Version Information that is deployed onto loans microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
